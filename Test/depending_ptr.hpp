...
basic_ostream<E, T>& operator<<(basic_ostream<E, T>& os, depending_ptr<Y> const& p) { return os << p.get(); }

// Constructors

template <typename T>
constexpr depending_ptr<T>::depending_ptr() noexcept : dp_rep(nullptr) {}
template <typename T>
depending_ptr<T>::depending_ptr(pointer v) noexcept : dp_rep(v) {}
template <typename T>
depending_ptr<T>::depending_ptr(nullptr_t) noexcept : depending_ptr() {}
template <typename T>
depending_ptr<T>::depending_ptr(const depending_ptr& d) noexcept : dp_rep(d.dp_rep) {}
template <typename T>
depending_ptr<T>::depending_ptr(const depending_ptr&& d) noexcept : dp_rep(d.dp_rep) {}

// Assignment
template <typename T>
depending_ptr<T>& depending_ptr<T>::operator=(pointer p) noexcept
{
    dp_rep = p;
    return *this;
}
template <typename T>
depending_ptr<T>& depending_ptr<T>::operator=(const depending_ptr<T>& d) noexcept
{
    dp_rep = d.dp_rep;
    return *this;
}
...
template <typename T>
depending_ptr<T>& depending_ptr<T>::operator=(nullptr_t) noexcept
{
    dp_rep = nullptr;
    return *this;
}
...
// Modifiers
template <typename T>
void depending_ptr<T>::swap(depending_ptr<T>& d) noexcept
{
    pointer p = d.dp_rep;
    d.dp_rep = dp_rep;
    dp_rep = p;
...
template <typename T>
depending_ptr<T> depending_ptr<T>::operator++(int)
{
...
template <typename T>
typename depending_ptr<T>::pointer depending_ptr<T>::get() const noexcept { return dp_rep; }
template <typename T>
depending_ptr<T>::operator bool() { return dp_rep; }
template <typename T>
T depending_ptr<T>::operator[](size_t idx) { return dp_rep[idx]; }

// Binary relational operators

template <typename T>
bool depending_ptr<T>::operator==(depending_ptr v) noexcept { return std::pointer_cmp_eq_dep(dp_rep, v.dp_rep); }
template <typename T>
bool depending_ptr<T>::operator!=(depending_ptr v) noexcept { return std::pointer_cmp_ne_dep(dp_rep, v.dp_rep); }
template <typename T>
bool depending_ptr<T>::operator<(depending_ptr v) noexcept { return std::pointer_cmp_gt_dep(dp_rep, v.dp_rep); }
template <typename T>
bool depending_ptr<T>::operator<=(depending_ptr v) noexcept { return std::pointer_cmp_ge_dep(dp_rep, v.dp_rep); }
template <typename T>
bool depending_ptr<T>::operator>(depending_ptr v) noexcept { return std::pointer_cmp_lt_dep(dp_rep, v.dp_rep); }
template <typename T>
bool depending_ptr<T>::operator>=(depending_ptr v) noexcept { return std::pointer_cmp_le_dep(dp_rep, v.dp_rep); }
template <typename T>
bool depending_ptr<T>::operator==(pointer v) noexcept { return std::pointer_cmp_eq_dep(dp_rep, v); }
template <typename T>
bool depending_ptr<T>::operator!=(pointer v) noexcept { return std::pointer_cmp_ne_dep(dp_rep, v); }
template <typename T>
bool depending_ptr<T>::operator<(pointer v) noexcept { return std::pointer_cmp_gt_dep(dp_rep, v); }
template <typename T>
bool depending_ptr<T>::operator<=(pointer v) noexcept { return std::pointer_cmp_ge_dep(dp_rep, v); }
template <typename T>
bool depending_ptr<T>::operator>(pointer v) noexcept { return std::pointer_cmp_lt_dep(dp_rep, v); }
template <typename T>
bool depending_ptr<T>::operator>=(pointer v) noexcept { return std::pointer_cmp_le_dep(dp_rep, v); }
